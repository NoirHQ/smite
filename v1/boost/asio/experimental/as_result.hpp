...
public:
  ...
  /// Constructor.
  template <typename T>
  BOOST_ASIO_CONSTEXPR explicit as_result_t(
...
BOOST_ASIO_CONSTEXPR as_result_t<typename decay<CompletionToken>::type>
as_result(BOOST_ASIO_MOVE_ARG(CompletionToken) completion_token)
{
