...
TEST_CASE("bytes: fixed-length byte sequence", "[noir][common]") {
  BytesN<32> hash{"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"};
  ...
  SECTION("construction & conversion") {
    ...
    auto from_span = BytesN<32>(std::span(hash));
