...
TEST_CASE("[crypto][hash] keccak256", "[noir]") {
...
TEST_CASE("[crypto][hash] sha256", "[noir]") {
  auto tests = std::to_array<std::pair<std::string, std::string>>({
...
TEST_CASE("[crypto][hash] blake2b_256", "[noir]") {
  auto tests = std::to_array<std::pair<std::string, std::string>>({
...
TEST_CASE("[crypto][hash] ripemd160", "[noir]") {
  auto tests = std::to_array<std::pair<std::string, std::string>>({
...
TEST_CASE("[crypto][hash] sha3_256", "[noir]") {
  auto tests = std::to_array<std::pair<std::string, std::string>>({
...
TEST_CASE("[crypto][hash] xxhash", "[noir]") {
